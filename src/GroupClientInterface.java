...
public interface GroupClientInterface
{
     ...
     *
     */
    public boolean createUser(final String username,final String password, final byte[] token);
     ...
     *
     */
    public boolean deleteUser(final String username, final byte[] token);
     ...
     *
     */
    public boolean createGroup(final String groupname, final byte[] token);
     ...
     *
     */
    public boolean deleteGroup(final String groupname, final byte[] token);
     ...
     *
     */
    public boolean addUserToGroup(final String user, final String group, final byte[] token);
     ...
     *
     */
    public boolean deleteUserFromGroup(final String user, final String group, final byte[] token);
