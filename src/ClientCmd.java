...
public class ClientCmd {
	...
	private void printCmds() {
		...
		System.out
				.println("\tGroup Connect: gConnect <server name> <port name>");
		...
		System.out
				.println("\tAdd User to Group: addUser <group name> <user name>");
		System.out
				.println("\tDelete User from Group: delUser <group name> <user name>");
		// file server commands
		System.out.println("File Commands:");
		System.out
				.println("\tFile Connect: fConnect <server name> <port name>");
		System.out.println("\tFile Disconnect: fDisconnect");
		System.out.println("\tList Files: lsFiles");
		System.out
				.println("\tUpload File: upload <src file name> <dst file name> <group name>");
		System.out
				.println("\tDownload File: download <src file name> <dst file name>");
